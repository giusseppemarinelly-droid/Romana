...
class DestinosView(ctk.CTkFrame):
    ...
    def _construir(self):
        ...
        titulo_h2(header, "📍 Destinos").pack(side="left")
        ...
        titulo_h2(right, "📝 Datos del Destino").pack(padx=18, pady=(15,10), anchor="w")
        ...
        etiqueta_campo(right, "Descripción", anchor="w").pack(fill="x", padx=18)
