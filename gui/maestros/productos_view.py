...
class ProductosView(ctk.CTkFrame):
    ...
    def _construir(self):
        ...
        titulo_h2(header, "📦 Productos").pack(side="left")
        ...
        titulo_h2(right, "📝 Datos del Producto").pack(padx=18, pady=(15,10), anchor="w")
        ...
        etiqueta_campo(right, "Unidad", anchor="w").pack(fill="x", padx=18, pady=(0,2))
        ...
        etiqueta_campo(right, "Descripción", anchor="w").pack(fill="x", padx=18, pady=(0,2))
    ...
    def _filtrar(self):
        ...
        cargar_en_hilo(
            self, lambda: api_client.listar_maestro("productos", search=termino or None),
            on_exito=self._poblar_tabla,
            on_error=lambda e: messagebox.showerror("Error de conexión", str(e)),
        )
